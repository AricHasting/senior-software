...
class Avatar_widget:
    ...
    def __init__(self, parent_frame, max_width = 200, max_height = 150):
        ...
        self.avatar_box = ttk.Combobox(parent_frame, textvariable = self.avatar_str,selectbackground=StColors.dark_grey,
        ...
        self.state_box = ttk.Combobox(parent_frame, textvariable = self.state_str,selectbackground=StColors.dark_grey,
                    background=StColors.light_grey, foreground=StColors.dark_blue)
